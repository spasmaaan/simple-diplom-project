...
using SimpleDiplomBackend.Infrastructure.ApiClients.GitHub;
using SimpleDiplomBackend.Infrastructure.Auth;
using SimpleDiplomBackend.Infrastructure.BackgroundJobs;
using SimpleDiplomBackend.Infrastructure.Cache.InMemory;
using SimpleDiplomBackend.Infrastructure.DataProtection;
using SimpleDiplomBackend.Infrastructure.Email;
using SimpleDiplomBackend.Infrastructure.Outboxes;
using Polly;
using Quartz;
using System.Net;
